...
<div class="bg-white p-4 sm:p-6 rounded-lg shadow-md">
    <div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
        <div class="w-full sm:w-auto sm:ml-auto flex flex-col sm:flex-row items-start sm:items-center gap-2">
            ...
            <a href="{{ route('binwasnaker.self-assessment-norma100.create') }}" class="w-full sm:w-auto flex items-center justify-center px-4 py-2 bg-primary text-white rounded-button hover:bg-primary/90 text-sm font-medium whitespace-nowrap mt-2 sm:mt-0">
                <i class="ri-add-line mr-1"></i> Tambah Data Assessment
            </a>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-center">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                {{-- <a href="{{ route('binwasnaker.self-assessment-norma100.show', $item->id) }}" class="text-gray-500 hover:text-gray-700" title="Lihat Detail">
                    ...
                    <tr>
                        <td colspan="9" class="px-4 py-10 text-center text-sm text-gray-500">
                            <div class="flex flex-col items-center">
                                ...
                                Tidak ada data self assessment norma 100 ditemukan.
                            </div>
                        </td>
                    </tr>
                @endforelse
