    ...
    <form method="GET" action="{{ route('binwasnaker.penerapan-smk3.index') }}" class="w-full">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 items-end">
            ...
            <div class="flex items-center space-x-2 pt-5">
                ...
                <a href="{{ route('binwasnaker.penerapan-smk3.index') }}" class="btn-secondary-outline">
                    Clear Filter
                </a>
            </div>
        </div>
        ...
        <table class="data-table">
            <thead>
                ...
                <tr>
                    ...
                    <th scope="col">{!! sortableLinkSmk3('tahun', 'Tahun', $sortBy, $sortDirection, $requestFilters) !!}</th>
                    <th scope="col">{!! sortableLinkSmk3('bulan', 'Bulan', $sortBy, $sortDirection, $requestFilters) !!}</th>
                    <th scope="col">{!! sortableLinkSmk3('provinsi', 'Provinsi', $sortBy, $sortDirection, $requestFilters) !!}</th>
                    <th scope="col" class="text-right">{!! sortableLinkSmk3('jumlah_perusahaan', 'Jumlah Perusahaan Yang Diaudit', $sortBy, $sortDirection, $requestFilters) !!}</th>
                    ...
                    <tr>
                        <td colspan="6" class="text-center py-10">
                            <div class="flex flex-col items-center text-gray-500">
                                ...
                                <span>Tidak ada data penerapan SMK3 ditemukan.</span>
                            </div>
                        </td>
                    </tr>
                @endforelse
