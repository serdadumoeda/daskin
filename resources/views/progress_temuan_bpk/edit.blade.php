...
@section('title', 'Edit Progres Temuan BPK')
@section('page_title', 'Edit Data Progres Temuan BPK')
...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="{{ route('inspektorat.progress-temuan-bpk.update', $progressTemuanBpk->id) }}" method="POST">
        @method('PUT')
