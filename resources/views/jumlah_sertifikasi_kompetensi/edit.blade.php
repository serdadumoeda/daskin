...
@section('title', 'Edit Jumlah Sertifikasi Kompetensi')
@section('page_title', 'Edit Data Jumlah Sertifikasi Kompetensi')

@section('content')
<div class="bg-white p-6 rounded-lg shadow-md">
     <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl font-semibold text-gray-800">Formulir Edit Data Sertifikasi</h2>
    ...
    <form action="{{ route('binalavotas.jumlah-sertifikasi-kompetensi.update', $jumlahSertifikasiKompetensi->id) }}" method="POST">
        @method('PUT')
