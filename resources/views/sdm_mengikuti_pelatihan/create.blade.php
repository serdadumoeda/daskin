...
@section('title', 'Tambah Data SDM Mengikuti Pelatihan')
@section('page_title', 'Tambah Data SDM Mengikuti Pelatihan')

@section('content')
<div class="bg-white p-6 rounded-lg shadow-md">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl font-semibold text-gray-800">Formulir Tambah Data Pelatihan SDM</h2>
    ...
    <form action="{{ route('sekretariat-jenderal.sdm-mengikuti-pelatihan.store') }}" method="POST">
