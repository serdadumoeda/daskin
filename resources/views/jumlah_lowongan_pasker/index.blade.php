        ...
        <table class="data-table">
            <thead>
                ...
                <tr>
                    ...
                    <th>{!! sortableLinkLowongan('tahun', 'Tahun', $sortBy, $sortDirection, $requestFilters, $routeNamePrefix) !!}</th>
                    <th>{!! sortableLinkLowongan('bulan', 'Bulan', $sortBy, $sortDirection, $requestFilters, $routeNamePrefix) !!}</th>
                    <th>{!! sortableLinkLowongan('jenis_kelamin', 'Jenis Kelamin', $sortBy, $sortDirection, $requestFilters, $routeNamePrefix) !!}</th>
                    <th>{!! sortableLinkLowongan('provinsi_penempatan', 'Prov. Penempatan', $sortBy, $sortDirection, $requestFilters, $routeNamePrefix) !!}</th>
                    <th>{!! sortableLinkLowongan('lapangan_usaha_kbli', 'Lap. Usaha (KBLI)', $sortBy, $sortDirection, $requestFilters, $routeNamePrefix) !!}</th>
                    <th>{!! sortableLinkLowongan('status_disabilitas', 'Status Disabilitas', $sortBy, $sortDirection, $requestFilters, $routeNamePrefix) !!}</th>
                    <th class="text-right">{!! sortableLinkLowongan('jumlah_lowongan', 'Jumlah', $sortBy, $sortDirection, $requestFilters, $routeNamePrefix) !!}</th>
            ...
            <tbody>
                ...
                @forelse ($jumlahLowonganPaskers as $index => $item)
                    <tr>
                        ...
                        <td class="max-w-[200px] truncate" title="{{ $item->lapangan_usaha_kbli }}">{{ Str::limit($item->lapangan_usaha_kbli, 30) }}</td>
                        <td>{{ $item->status_disabilitas_text }}</td>
                        <td class="text-right">{{ number_format($item->jumlah_lowongan) }}</td>
                    ...
                    <tr>
                        <td colspan="9" class="text-center py-10">
                            <div class="flex flex-col items-center text-gray-500">
                                ...
                                <span>Tidak ada data lowongan Pasker ditemukan.</span>
                            </div>
                        </td>
                    </tr>
                @endforelse
