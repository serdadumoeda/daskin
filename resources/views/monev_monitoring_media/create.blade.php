...
@section('title', 'Tambah Data Monev Monitoring Media')
@section('page_title', 'Tambah Data Monev Monitoring Media')

@section('content')
<div class="bg-white p-6 rounded-lg shadow-md">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl font-semibold text-gray-800">Formulir Tambah Data Monev Media</h2>
    ...
    <form action="{{ route('sekretariat-jenderal.monev-monitoring-media.store') }}" method="POST">
