...
@section('title', 'Edit Data Persetujuan RPTKA')
@section('page_title', 'Edit Data Persetujuan RPTKA')

@section('content')
<div class="bg-white p-6 rounded-lg shadow-md">
     <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl font-semibold text-gray-800">Formulir Edit Data Persetujuan RPTKA</h2>
    ...
    <form action="{{ route($routeNamePrefix . 'update', $persetujuanRptka->id) }}" method="POST">
        @method('PUT')
        {{-- 
