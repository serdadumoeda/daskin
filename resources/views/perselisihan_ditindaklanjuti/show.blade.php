...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    <div class="space-y-3 text-sm">
        ...
        <div><strong class="text-gray-600 w-48 inline-block">Jumlah Penyelesaian Perselisihan:</strong> <span class="text-gray-800">{{ number_format($perselisihanDitindaklanjuti->jumlah_ditindaklanjuti) }}</span></div>
